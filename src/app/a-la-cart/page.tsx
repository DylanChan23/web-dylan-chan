      ...
      <header className="grid grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className="p-20 flex flex-col gap-8">
          <div className="w-full flex justify-between">
            <h1>
              A La Cart <span className="text-lore text-lg">- Project</span>
            </h1>
          ...
          <p>
            Open the{" "}
            <Link href="/byte-me" className="inline-flex items-center gap-1">
              Byte Me dashboard project{" "}
          ...
          <div className="flex gap-8">
            <a
              href="https://a-la-cart.dylanchan.dev"
              target="_blank"
      ...
      <section className="side-margin" aria-labelledby="tech-stack-title">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="bg-black-custom/60 text-beige-custom p-4 text-center">
            ...
            <CardContent className="flex justify-center">
              <ul className="flex flex-wrap gap-3">
                <li className="bubble">Shared API (Byte Me backend)</li>
                <li className="bubble">PostgreSQL (Drizzle ORM)</li>
                <li className="bubble">Better Auth sessions</li>
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          <Card className="flex flex-row justify-between p-4 items-center bg-beige-custom/20">
            ...
            <RocketIcon
              className="h-6 w-6 text-beige-custom"
              aria-hidden="true"
            />
          </Card>
          <Card className="flex flex-row justify-between p-4 items-center bg-beige-custom/20">
