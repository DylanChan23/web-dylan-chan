    ...
    <section className="w-full min-h-screen">
      ...
      <div className="w-full h-screen flex items-center justify-center bg-linear-to-b from-black-custom/0 from-50% to-black-custom/50">
        <div className="flex flex-col items-center">
          ...
          <p
            className={`${lore.className} -mt-2 text-blue-800 text-center text-[clamp(1rem,4vw,6rem)] -rotate-4`}
          >
            Gone creative mode !
          </p>
        </div>
      ...
      {/* Projects */}
      <div className="bg-linear-to-b from-black-custom/90 to-20% to-black-custom pt-80 side-margin">
      ...
      {/* Skills */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 bg-linear-to-b from-black-custom from-15% to-black-custom/40 pt-80 pb-50 items-start side-margin">
